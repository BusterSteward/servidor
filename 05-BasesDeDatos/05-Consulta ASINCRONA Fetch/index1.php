...
function fetch_baja(elnif)
{
	...
	// al script PHP le pasamos el "nif" 
	var url = "PHP-baja.php?nifusuario="+elnif.trim();
	// hago la llamada al script
	fetch(url,
	{ 
		method: "GET"
	...
	{	
		...
		// aviso al usuario si lo ha borrado 
		//*********************************
...
<div class="contenedor-formulario">
	...
	onsubmit="return false;"> 
		...
		<div class="form-group" align="left">
								...
								onclick="fetch_baja(document.getElementById('nif').value);">
