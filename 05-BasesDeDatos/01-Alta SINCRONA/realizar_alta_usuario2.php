...
// ver ejemplo -> realizar_alta_usuario2.php (MYSQLI_REPORT_STRICT)
// ver gestión de excepciones
// 
...
{
	$numerror=mysqli_errno($conexion); 
	echo "<b><font face='Calibri' color='red' size='3'>Error $numerror : NIF de socio ya existe !!</font></b>";
	//echo "" . $e->getMessage();
