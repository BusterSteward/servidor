...
function hago_llamada_ajax()
{
	...
	.then (function(datos)
	{
		...
		// aquí podríamos tratar más tipos de error
		else
		{
			document.getElementById('mensaje').innerHTML="<b><font face='Calibri' color='red' size='3'>Error "+datos+": NIF de socio ya existe!!</font><b>";
			limpio_pantalla(1);
		}	
	})
...
{
	alert('he pulsado el botón submit');
}
//**********************************************************************************
</script>
...
<div class="BarraNavegar">
				...
				<label  class="L3">ASÍNCRONA (Fetch JavaScript)</label>	
