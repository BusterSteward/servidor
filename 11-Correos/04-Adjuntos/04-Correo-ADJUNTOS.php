...
require('conexion_mail.php');
  ...
  $mail->AddAddress($AddAddress);
   ...
   // Ficheros Adjuntos
   // el parámetro nº1: nombre real del fichero
   // el parámetro nº2: nombre como lo recibirá el destinatario
   $mail->AddAttachment("Imagen1.jpg", "fichero1.jpg");	
   $mail->AddAttachment("FicheroPrueba.pdf", "fichero2.pdf");	 
  ...
  $mail->Body =" 
								...
								<br>
								<font face='Calibri' font color='red' size='4' font-weight: extra-bold>
								Esto es un mensaje de prueba con FICHEROS ADJUNTOS</font>
								<br>
								<br>
