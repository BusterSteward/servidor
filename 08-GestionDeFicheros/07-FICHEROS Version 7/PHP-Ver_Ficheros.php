			...
			while($file=readdir($handle))
			{
				 ...
				 if (is_file($d.$file))
				 {
					  ...
					  if ($extension=='.jpg' OR $extension=='.png' OR $extension=='.bmp') 
					  {
						  ...
						  // la llamada a "DescargoFichero.php" será SÍNCRONA
						  // en este caso no hay problema de esperas ya que el script PHP no tarda nada en iniciar una descarga
						  echo "
						  <td width='145' align='right'  style='background-color:#ACFA58;color:#0404B4';font-family:Calibri;>".
						  "<a href='PHP-DescargoFichero.php?nombref=".$file."'>".$file."</a></td>";
						   echo "						  
						  ...
						  echo "
						  <td width='40' align='center'  style='background-color:#FAF78D;color:#0404B4';>".
						  "<input type='checkbox' id='marca2' name='marca2[]' value='".$file."' style='cursor:pointer'>"."</td>";						  
						   echo "</tr>";
						  $i++;
					  }
				 }
