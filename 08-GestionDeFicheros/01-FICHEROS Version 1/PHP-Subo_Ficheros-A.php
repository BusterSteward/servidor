<?php
	...
	$tipo = substr($_FILES['objetofile2']['type'], 0, 5);
	 ...
	 if ($tipo == 'image')
	  {
			...
			//echo $_FILES['objetofile2']['tmp_name'];
			if (!copy($_FILES['objetofile2']['tmp_name'], $dir.$_FILES['objetofile2']['name']))
			...
			echo "<font face='Calibri' color='blue' size='3'>".$_FILES['objetofile2']['name']."</font>"."<br>";
