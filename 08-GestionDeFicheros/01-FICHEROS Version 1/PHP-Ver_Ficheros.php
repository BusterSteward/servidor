		...
		if ($handle=opendir($d))
		{
			...
			while($file=readdir($handle))
			{
				 ...
				 if (is_file($d.$file))
				 {
					  ...
					  {
						   echo "<tr>
						  <td width='30' height='20px' align='center'  style='background-color:#FA58F4;color:#FFFFFF';font-family:Calibri;>".$i."</td>";
						  echo "
						  <td width='160' height='20px' align='right'  style='background-color:#ACFA58;color:#0404B4';font-family:Calibri;>".$file."</td></tr>";
						  $i++;
					  }
				 }
			}
