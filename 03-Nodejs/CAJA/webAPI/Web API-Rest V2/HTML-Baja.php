...
<div class="contenedor-formulario">
			...
			<div class="form-group">
				...
				<input class="input-control" id="id" name="id" type="number"  min="1" max="999" style="width:10%" required autocomplete="off"
			...
			onclick="borrar_API(document.getElementById('id').value);">
