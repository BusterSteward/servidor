<!-- lo primero que tendremos que hacer es saber si hay una sesión iniciada -->
<!-- si hay una sesión iniciada -> tendremos que cargar la página de correo -->

<!-- ¿cómo podemos saber si una sesión se ha iniciado? -->
		...
		<div class="contenedor2">
				...
				<div class="contenedor4">
								<div class="form-group">
									...
									style="width: 65%;" required autocomplete="off">
								</div>
