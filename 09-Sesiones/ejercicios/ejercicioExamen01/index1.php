<?php 
	...
	// si existe la variable de sesión -> eso significa que no se ha cerrado la sesión
...
{
		let elusuario=document.getElementById('user').value;
		...
		else
		{
			...
			const url="PHP-verificacion.php";
...
function llegadaDatos1(datos)
{
	...
	if (datos==0)
	{
		...
		info.innerHTML="<font color='red'>Error Validación !!!</font>";
	...
	{
		// aviso validación
		info.innerHTML="<font color='green'>Validación correcta !!!</font>";
...
function jugar()
{
	...
	else if (contador==40)
	{
		...
		//*********************************************************************************
		const url="PHP-altadejugada.php";
		console.log(contador1);
		$.post(url,{njugada:contador1,fruta1:imagen_fruta1,fruta2:imagen_fruta2,fruta3:imagen_fruta3},llegadaDatos3);
