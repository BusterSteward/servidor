...
foreach($_SESSION['ID'] as $x)
{
		...
		<tr>  
			  ...
			  <td style='background-color:#ACFA58;color:#0404B4';>".$_SESSION['CANTIDAD'][$x]."</td>
...
echo "<tr><td colspan='7' style='color:blue;text-align: right;'>Total Factura:</td><td style='color:brown;text-align: right;'>".number_format($totalfactura,2,".","")."&nbsp€&nbsp</td></tr>";
echo "</table>";
?>
