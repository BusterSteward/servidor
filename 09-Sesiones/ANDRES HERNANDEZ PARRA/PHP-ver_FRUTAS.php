<?php	
	...
	// CREACIÓN TABLA
	//**************************************************
	echo "<table id='mitabla' width=280px style='padding-top:10px'>";
	...
	for($fila;$fila<=$filas;$fila++){
		...
		for($columna=0;$columna<$columnas;$columna++){
			echo "
			<td width='50' height='35' align='center' style='background-color:#ccc;color:#FFFFFF';> <img width='120px' src='./imagenes/".$_SESSION['TABLA']['FILA'.$fila][$columna].".jpg'</td>";
		}
		echo "<tr>";
	}
