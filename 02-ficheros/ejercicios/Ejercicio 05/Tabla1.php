		...
		style="border:2px solid green;width:800px;height:490px;padding-left:60px;position:absolute;
					...
					<div style="border:1px solid red;width:375px;">  
						<table border='1' cellpadding='0' cellspacing='0' width='375' bordercolor='#FFFFFF'> 
							...
							<?php $i=0;while ($i<=15) { ?>
						  <tr>
								<td width='150' style='background-color:#F6CECE;color:#0404B4';><?php echo "PEPE";?></td>
								<td width='100' style='background-color:#A9E2F3;color:#0404B4';><?php echo $i;?></td>
								<td width='125' style='background-color:#81F79F;color:#0404B4';><?php echo "ALBACETE";$i++;?></td>
						  </tr>
						  <?php };?>					
